...
export default function Sidebar({
  ...
  googleAccount = 'odimman.2@gmail.com',
    ...
    <div className="min-h-screen bg-[#0a0b0d] text-slate-100 flex flex-col md:flex-row font-sans relative overflow-hidden">
      ...
      <aside className="hidden md:flex flex-col justify-between w-64 bg-[#111216] border-r border-slate-800 shrink-0 p-6 z-10 print:hidden">
        ...
        <div className="space-y-2.5 pt-4 border-t border-slate-800">
          {/* Google Cloud Status Badge */}
          <div 
            onClick={() => onNavigate('settings')}
            className="flex items-center justify-between px-3 py-1.5 bg-emerald-950/30 hover:bg-emerald-950/50 border border-emerald-500/25 rounded-xl text-xs cursor-pointer transition-all group"
            title="Google Cloud Conectado (odimman.2@gmail.com)"
          >
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-[11px] font-bold text-emerald-200 truncate leading-none">Google Cloud</p>
                <p className="text-[9px] text-emerald-400/80 truncate mt-0.5">{googleAccount}</p>
              </div>
            </div>
          ...
          <div 
            onClick={() => onNavigate('settings')}
            className="flex items-center justify-between px-3 py-1.5 bg-sky-950/30 hover:bg-sky-950/50 border border-sky-500/25 rounded-xl text-xs cursor-pointer transition-all group"
            title="Base de Dados iCloud Conectada (odilsonn@icloud.com)"
          >
            <div className="flex items-center gap-2 min-w-0">
              <span className="relative flex h-2 w-2 shrink-0">
